% Demo of AFFECT k-means clustering on simulated data set consisting of
...
[ids,W,labels] = generate_Gaussians_data('dot_prod');

disp('Clustering data using AFFECT k-means clustering')
[clu_est,W_bar_est,alpha_est] = batch_affect_kmeans(ids,W,2,'output',1);

disp('Clustering data using static k-means clustering')
clu_sta = batch_affect_kmeans(ids,W,2,'output',1,'alpha',0);
