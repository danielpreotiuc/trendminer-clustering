function clu_vect = clumat2cluvect(clu_mat)
% CLUMAT2CLUVECT	Convert cluster membership matrix to vector
% 
% clumat2cluvect(clu_mat) converts the cluster membership matrix
